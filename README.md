...
- Chapters "SDKs for Java SE and Android" and "JMS Features for Java SDKs" of [*Lightstreamer JMS Extender Documentation*](https://lightstreamer.com/docs/jmsext/latest/JMS+Extender+Documentation.pdf)
